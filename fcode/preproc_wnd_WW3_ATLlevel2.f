c Program to read winds from Oceanweather and convert to WAM format
      ...
      Dimension u(1000,1000), v(1000,1000),uout(1000,1000),
     .          uin(1000,1000), vin(1000,1000), vout(1000,1000)
      Character *8 forma
...
c     Print 305, idate, kbad_wnd 
      do j = 1,nrread
         Write (12,'(12f8.3)') (uout(i,j), i=1,ncread+4)
      enddo
      do j = 1,nrread
      	Write (12,'(12f8.3)') (vout(i,j), i=1,ncread+4)
      enddo
