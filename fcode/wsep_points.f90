...
DO jj = 1,nlat
      read(10,200,end=555) (Hmo(ii,jj),ii=1,nlon)
  555 read(11,200,end=556) (Hsw1(ii,jj),ii=1,nlon)
  556 read(12,200,end=557) (Hsw2(ii,jj),ii=1,nlon)
  557 read(13,200,end=558) (Hss(ii,jj),ii=1,nlon)
  558 read(02,*,end=559) (dep(ii,jj),ii=1,nlon)
  559 read(14,200) (u(ii,jj),ii=1,nlon)

ENDDO
DO jj = 1,nlat
      read(14,200,end=600) (v(ii,jj),ii=1,nlon)
ENDDO
  600 DO jj = 1,nlat
         DO ii = 1,nlon
