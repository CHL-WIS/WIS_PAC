...
def create_stat_var_att(h5file,datakeys):
    longn = {'time':'Time in Days since 0001-01-01 00:00:00','datetime':'Time in yyyy,mm,dd,hh,mm,ss','wavhs':'Wave Height Total','wavtp':'Peak Period Total','wavtpp':'Parabolic Fit Peak Period Total','wavetm':'Mean Period Total','wavtm1':'1st Moment Mean Period Total','wavtm2':'2nd Moment Mean Period Total','wavdir':'Mean Wave Direction Total','wavspr':'Wave Direction Spreading Total','frequency':'Frequency','direction':'Direction','ef2d':'Sea-Surface Energy Density Spectrum','wndspd':'10-m Wind Speed','wnddir':'Wind Direction','ustar':'Friction Velocity','cd':'Coefficient of Drag','ef2d_swell':'Sea-Surface Energy Density Spectrum for Swell','ef2d_wndsea':'Sea-Surface Energy Density Spectrum for WindSea','wavhs_wndsea':'Wave Height WindSea','wavtp_wndsea':'Peak Period WindSea','wavtpp_wndsea':'Parabolic Fit Peak Period WindSea','wavetm_wndsea':'Mean Period WindSea','wavtm1_wndsea':'1st Moment Mean Period WindSea','wavtm2_wndsea':'2nd Moment Mean Period WindSea','wavdir_wndsea':'Mean Wave Direction WindSea','wavspr_wndsea':'Wave Direction Spreading WindSea','wavhs_swell':'Wave Height Swell','wavtp_swell':'Peak Period Swell','wavtpp_swell':'Parabolic Fit Peak Period Swell','wavetm_swell':'Mean Period Swell','wavtm1_swell':'1st Moment Mean Period Swell','wavtm2_swell':'2nd Moment Mean Period Swell','wavdir_swell':'Mean Wave Direction Swell','wavspr_swell':'Wave Direction Spreading Swell'}
